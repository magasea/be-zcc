...
public interface CustAmcCmpycontactorMapper {
    ...
    int updateByExampleSelective(@Param("record") CustAmcCmpycontactor record,
        @Param("example") CustAmcCmpycontactorExample example);

    int updateByExample(@Param("record") CustAmcCmpycontactor record,
        @Param("example") CustAmcCmpycontactorExample example);

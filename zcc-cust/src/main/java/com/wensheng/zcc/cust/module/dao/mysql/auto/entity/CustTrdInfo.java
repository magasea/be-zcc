...
public class CustTrdInfo {
    ...
    public String getTrdContactorTel() {
        return trdContactorTel;
    }

    public void setTrdContactorTel(String trdContactorTel) {
        this.trdContactorTel = trdContactorTel == null ? null : trdContactorTel.trim();
    }

    public String getTrdContactorMobile() {
        return trdContactorMobile;
    }

    public void setTrdContactorMobile(String trdContactorMobile) {
        this.trdContactorMobile = trdContactorMobile == null ? null : trdContactorMobile.trim();
    }
